...
for(i=0;i<=7;i++){
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!CONGRATUALATIONS!!! click reset");			 break;
                   }
             else if(icon1==ic2){ 
             b[(a[i][1]-1)].setIcon(ic22);
             b[(a[i][2]-1)].setIcon(ic22);
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(TTT1.this,"!!!OHH YOU LOST (COMPUTER) won!!! click reset");
                break;			 
               }
         }
    }  
